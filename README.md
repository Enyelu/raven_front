...
```
cd existing_repo
git remote add origin https://gitlab.com/access-talent-program/raven_frontend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/-/experiment/new_project_readme_content:afed5b26549e6e80cade1d2d0114d40c?https://gitlab.com/access-talent-program/raven_frontend/-/settings/integrations)
